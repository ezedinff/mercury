...
const Project = ({ props, history }) => {
  const { project } = history.location.state;
  console.log(history, history.location.state.project, "singel project");
  console.log(history.location.state.project, "");
  return (
    <div>
      {project && (
